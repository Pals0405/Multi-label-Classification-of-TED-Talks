...
# -*- coding: utf-8 -*-
"""
Created on Mon April  4 00:53:40 2022
...
def analyzeTopics(tags):
    ...
    frequentTags = Counter(allTags).most_common(10)
    #print(frequentTags)
    #print(len(allTags))
...
def deepNeural(X, y, t):
    ...
    # main approach (simple LSTM)
    model.add(LSTM(50))
    
    # Stacked LSTM 
    # model.add(LSTM(50, return_sequences=True))  # returns a sequence of vectors of dimension 32  # returns a sequence of vectors of dimension 32
